...
class K8sTestEnvironment:
    ...
    def test_backend(self):
        ...
        try:
            ...
            logger.error(f"Backend test failed: {e!s}")
            return False
    ...
    def test_frontend(self):
        ...
        try:
            ...
            logger.error(f"Frontend test failed: {e!s}")
            return False
    ...
    def e2e_test_workflow(self):
        ...
        try:
            ...
            logger.error(f"E2E test workflow failed: {e!s}")
            return False
    ...
    def run(self, cleanup_on_success=True, cleanup_on_failure=False):
        ...
        try:
            ...
            logger.error(f"Test run failed with exception: {e!s}")
            return False
        finally:
